...
{
    public class YunObjWaypoint : MonoBehaviour
    {
        ...
        public Vector3 GetRoutePosition(float dist)
        {
            ...
            p1n = ((point - 1) + NumWP) % NumWP;
            p2n = point;
            i = Mathf.InverseLerp(distances[p1n], distances[p2n], dist);
                p0n = ((point - 2) + NumWP) % NumWP;
                p3n = (point + 1) % NumWP;
                p2n = p2n % NumWP;
                P0 = points[p0n];
                P1 = points[p1n];
        ...
        [Serializable] public class WaypointList
        {
            public YunObjWaypoint circuit;
...
{
#if UNITY_EDITOR
    [CustomPropertyDrawer(typeof (YunObjWaypoint.WaypointList))]
    public class WaypointListDrawer : PropertyDrawer
    {
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            if (GUI.Button(addAllButtonRect, "Use all child objects"))
            {
                var circuit = property.FindPropertyRelative("circuit").objectReferenceValue as YunObjWaypoint;
            ...
            if (GUI.Button(renameButtonRect, "Auto Rename"))
            {
                var circuit = property.FindPropertyRelative("circuit").objectReferenceValue as YunObjWaypoint;
                int n = 0;
